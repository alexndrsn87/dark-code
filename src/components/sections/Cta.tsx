  ...
  return (
    <section className="px-4 py-24 md:py-32">
      <div className="section-shell">
        <div className="rounded-[2rem] border border-[var(--accent)]/25 bg-[var(--accent)] px-8 py-12 text-black md:px-12">
          <p className="font-mono text-xs uppercase tracking-[0.28em] opacity-70">Free preview</p>
